...
<br>
  ...
  <br>
    ...
    <div id="youtube_video">
          <p align="center">  
          <iframe width="560" height="315" src="https://www.youtube.com/embed/VVpHAfj1rdc" frameborder="0" allowfullscreen></iframe>
            </p>
            <br>
          </div>
          <script>
...
if(!empty($email_address))
{
    ...
    $from="qwikdraft@gmail.com";
      $subject ='Qwikdraft - Column Details';
      ...
      ';
      echo '<a href="/Column Details.zip" download="Column details"> Download </a>';
